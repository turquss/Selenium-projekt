...
valid_pw = "wpisz haslo"
invalid_password = "wpisz haslo"
valid_address_mail = "wpisz @"
...
class WpPocztaMail(unittest.TestCase):
    ...
    def testEmailLogging(self):
        ...
        # KROK  : Wpisz poprawny adres i haslo
        driver = self.driver
    ...
    def testInvalidEmailLogging(self):
        print("Prawdziwy test")
        # KROK 1 : Wpisz poprawny adres
        driver = self.driver
        email_input = driver.find_element_by_name('login_username')
        email_input.send_keys(valid_email)
        # KROK 2: Wpisz niepoprawne haslo
        password_input = driver.find_element_by_name('password')
